...
class Test implements A.I1
{
	public static void main(String[]arg)
		{
			A x=new A();		
			A x1=new A(A.in.nextInt());
			System.out.println(x.m1(A.in.nextInt()));
			I1 y=new I1()
			{
				public long m2(String s)
				{
					return A.in.nextLong();
				}	
			};
			System.out.println(y.m2(A.in.next()));
			System.out.println(y.m3(A.in.nextLong()));
			System.out.println(A.I1.m4(A.in.nextFloat()));
